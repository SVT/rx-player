...
var MAX_TIME_MISSING_FROM_COMPLETE_SEGMENT = config.MAX_TIME_MISSING_FROM_COMPLETE_SEGMENT, MAX_BUFFERED_DISTANCE = config.MAX_BUFFERED_DISTANCE, MINIMUM_SEGMENT_SIZE = config.MINIMUM_SEGMENT_SIZE;
/**
...
var SegmentBookkeeper = /** @class */ (function () {
    ...
    SegmentBookkeeper.prototype.synchronizeBuffered = function (buffered) {
        ...
        var ranges = convertToRanges(buffered);
        /**
            ...
            if (!prevSegmentI ||
                ...
                if (_wantedRange.start > currentSegmentI.start) {
                    ...
                    if (wantedDiff > 0 && timeDiff
                        ...
                        log.debug("SB: The wanted segment has been garbage collected", currentSegmentI);
                        return false;
                    }
                }
                else {
...
export default SegmentBookkeeper;
