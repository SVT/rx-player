...
var Manifest = /** @class */ (function (_super) {
    ...
    function Manifest(args, options) {
        ...
        if (args.utcTimings && args.utcTimings.length > 0 && args.utcTimings[0].value) {
            _this._clockOffset = Date.now() - Date.parse(args.utcTimings[0].value);
            log.info("Manifest: Clock offset set to " + _this._clockOffset + ".");
        }
        /**
    ...
    Manifest.prototype.getTime = function () {
