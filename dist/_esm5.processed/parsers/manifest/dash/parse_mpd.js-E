...
function parseCompleteIntermediateRepresentation(mpdIR, args) {
    ...
    if (parsedMPD.isLive) {
        ...
        if (clockOffsetFromDirectUTCTiming == null &&
            lastTimeReference_1 == null && args.loadExternalClock) {
                    ...
                    value: {
                        ...
                        continue: function continueParsingMPD(loadedRessources) {
                            ...
                            parsedMPD.presentationLiveGap =
                                getPresentationLiveGap(parsedMPD, lastTimeReference_1);
        ...
        parsedMPD.presentationLiveGap = getPresentationLiveGap(parsedMPD, lastTimeReference_1);
    }
    return { type: "done", value: parsedMPD };
}
