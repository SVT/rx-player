...
export default function PeriodBuffer(_a) {
    var abrManager = _a.abrManager, bufferType = _a.bufferType, clock$ = _a.clock$, content = _a.content, garbageCollectors = _a.garbageCollectors, segmentBookkeepers = _a.segmentBookkeepers, segmentPipelinesManager = _a.segmentPipelinesManager, sourceBuffersManager = _a.sourceBuffersManager, options = _a.options, wantedBufferAhead$ = _a.wantedBufferAhead$;
