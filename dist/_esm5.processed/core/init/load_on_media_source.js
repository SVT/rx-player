 ...
 */
import { EMPTY, merge as observableMerge, of as observableOf, timer as observableTimer, Subject, } from "rxjs";
import { finalize, ignoreElements, switchMap, tap, map, mapTo, mergeMap, takeUntil, } from "rxjs/operators";
...
function waitForInitialPeriod(manifest, initialTime) {
    ...
    if (initialPeriod != null) {
        return observableOf({ initialPeriod: initialPeriod, initialTime: initialTime });
    }
...
export default function createMediaSourceLoader(_a) {
    ...
    return function loadContentOnMediaSource(mediaSource, initialTime, autoPlay) {
        var setup = function (initialPeriod, initialTime) {
        ...
        return initialPeriod$.pipe(tap(function (_a) {
            var initialPeriod = _a.initialPeriod, initialTime = _a.initialTime;
            return log.info("GOT FIRST PERIOD: start=" + initialPeriod.start + " initialTime=" + initialTime);
        }), switchMap(function (_a) {
            var initialPeriod = _a.initialPeriod, initialTime = _a.initialTime;
            return setup(initialPeriod, initialTime);
        }));
    };
}
/**
