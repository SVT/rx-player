...
var QueuedSourceBuffer = /** @class */ (function () {
    ...
    function QueuedSourceBuffer(bufferType, codec, sourceBuffer) {
        ...
        fromEvent(this._sourceBuffer, "error").pipe(tap(function (err) { return _this._onErrorEvent(err); }), takeUntil(this._destroy$)).subscribe();
    ...
    QueuedSourceBuffer.prototype.appendBuffer = function (infos) {
        log.debug("QSB: receiving order to push data to the SourceBuffer", this.bufferType);
    ...
    QueuedSourceBuffer.prototype.removeBuffer = function (start, end) {
        log.debug("QSB: receiving order to remove data from the SourceBuffer", this.bufferType);
     ...
     */
    QueuedSourceBuffer.prototype._onErrorEvent = function (err) {
